...
static int
hwloc_darwin_component_instantiate(struct hwloc_topology *topology __hwloc_attribute_unused,
...
void
hwloc_darwin_component_register(struct hwloc_topology *topology)
{
  hwloc_component_register(topology, &hwloc_darwin_component);
}
